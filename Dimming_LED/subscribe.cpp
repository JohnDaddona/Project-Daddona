...
#define TOPIC       "John_D51/feeds/led-dimmer" 
...
int msgarrvd(void *context, char *topicName, int topicLen, MQTTClient_message *message) {
    ...
    PWM pin_number("pwm-1:0");
    pin_number.setPeriod(4000);
    pin_number.setPolarity(PWM::ACTIVE_LOW);
    pin_number.setDutyCycle(dutyCycle);
    pin_number.run();  
